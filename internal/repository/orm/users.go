...
var UserWhere = struct {
	...
	Country:   whereHelpernull_String{field: "\"users\".\"country\""},
...
var (
	userAllColumns            = []string{"id", "username", "password", "email", "address", "phone", "country", "company", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id"}
	userColumnsWithDefault    = []string{"username", "password", "email", "address", "phone", "country", "company", "created_at", "updated_at"}
